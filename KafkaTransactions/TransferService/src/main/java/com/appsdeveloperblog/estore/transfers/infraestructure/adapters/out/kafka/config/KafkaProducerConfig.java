package com.appsdeveloperblog.estore.transfers.infraestructure.adapters.out.kafka.config;
...
/**
 * Configuración del productor transaccional de Kafka. Define el
 * {@link ProducerFactory} idempotente/transaccional, el {@link KafkaTemplate}
 * y el {@link KafkaTransactionManager} que la capa de aplicación usa como
 * frontera transaccional. También declara los topics de retiro y depósito.
 */
@Configuration
